...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\jshin\\OW_closedloopLIFU\\stroop\\stroop_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if len(streams) == 0:
        print("ERROR: No LIFUEvents stream found.")
        lifu_inlet = None
    else:
    ...
    thisExp.currentRoutine = instruct
    ...
    while continueRoutine:
        ...
        if instruct.forceEnded or routineForceEnded:
            break
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if lifu_inlet is not None:
                ...
                if sample is not None:
                    last_lifu_event = sample[0]   # KEEP the last non-None marker
                    last_lifu_time = ts
        ...
        thisExp.addData('LIFU_marker_time', last_lifu_time)
